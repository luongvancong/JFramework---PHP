...
class Image {
	 ...
	 * @var array
	 */
	private $extensions = array('gif','jpg','jpeg','png');

	/**
	 * Max filesize upload
	 * @var integer
	 */
	private $filesizeLimit = 3072; // Max filesize is 3MB


	private $removeHaivlWaterMask = false;
	 ...
	 * setFilesizeLimit
	 *
	 * @param integer $size KB 1024 | 2048....
	 */
	public function setFilesizeLimit($size) {
